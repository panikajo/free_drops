  ...
  <div id="mainContent">
   ...
   <form action="" method="post" class="form">
    ...
    <div class="area<?=(!empty($errors['text']))? ' error_field': '';?>">
    	...
    	<textarea cols="40" class = "textarea" rows="5" placeholder="Введите подробное описание вашей проблемы."><?=$validator->postdata('text');?></textarea>
    </div> 
